...
export class Carousel extends React.Component<CarouselProps, CarouselInternalState> {
  ...
  public render(): React.ReactNode {
    ...
    return (
      <>
        ...
        <div
          className={cx('react-multi-carousel-list', className)}
          ref={this.containerRef}
        >
          <ul
            ref={this.listRef}
            className={cx('react-multi-carousel-track', sliderClass)}
            style={{
