...
const InternalDialogContainer: React.FC<{ justifyContent: string, alignItems: string }> = (props) => (
  <div
    style={{
      position: 'fixed',
      top: 0,
...
export const Dialog = ({
  ...
  const dialog = (
    <DialogContainer data-testid="react-spring-dialog-container" justifyContent={justifyContent} alignItems={alignItems}>
      {renderBackdrop && (
        <animated.div
